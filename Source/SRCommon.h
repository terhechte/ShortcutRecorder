...
#define DGImage(name) [[[NSImage alloc] initWithContentsOfFile: [[NSBundle bundleForClass: [self class]] pathForImageResource: name]] autorelease]
...
#define SRChar(x) [NSString stringWithFormat:@"%C", (short)x]
